...
import 'package:yoklama_mobil/Screen/Login/RegisterScreen.dart';
import 'package:yoklama_mobil/Services/LoginServices/LoginServices.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void _performLogin() async {
    ...
    try {
      bool loginSuccess = await login(context, email, password);
      ...
      if (loginSuccess) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Kimlik bilgileri hatalı!')),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(
